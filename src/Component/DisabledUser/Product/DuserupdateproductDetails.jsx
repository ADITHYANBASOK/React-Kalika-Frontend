...
function DuserupdateproductDetails() {
    const {id} =useParams()
  // id = parseInt(id, 10)
  console.log("hai");
  ...
  useEffect(() => {
    console.log("hai",id);
    axios.get(`http://localhost:4000/product/updateourproduct/${id}`).then((response) => {
  ...
  const submit = (e)=>{
    e.preventDefault();
    console.log(user);
    axios.post(`http://localhost:4000/product/updatedproducts/${id}`,user).then((response)=>{console.log("res====>",response.data);
        ...
        <div className="row g-0" >
          ...
          <div className="col-md-6 bg-dark d-flex align-items-center">
            <div className="p-5 wow fadeInUp" data-wow-delay="0.2s">
              ...
              <h1 className="text-white mb-4">Update product</h1>
              <form>
...
export default DuserupdateproductDetails
