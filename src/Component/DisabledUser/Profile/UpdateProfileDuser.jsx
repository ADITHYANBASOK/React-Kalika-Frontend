...
function UpdateProfileDuser() {
    ...
    const inputchange = (e)=>{
      ...
      useEffect(() => {
        ...
        axios.get(`http://localhost:4000/register/updateduserourprofile/${duser_id}`).then((response) => {
      ...
      const Update = (e)=>{
        e.preventDefault();
        console.log(user);
        axios.post(`http://localhost:4000/register/updatedduserprofile/${duser_id}`,user).then((response)=>{console.log("res====>",response.data);
...
export default UpdateProfileDuser
