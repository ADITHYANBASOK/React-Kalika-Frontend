...
function UpdateDoctorprofile() {
    ...
    const inputchange = (e)=>{
      ...
      useEffect(() => {
        console.log("hai",id);
        axios.get(`http://localhost:4000/register/updatedoctorourprofile/${id}`).then((response) => {
      ...
      const Update = (e)=>{
        e.preventDefault();
        console.log(user);
        axios.post(`http://localhost:4000/register/updateddoctorprofile/${id}`,user).then((response)=>{console.log("res====>",response.data);
